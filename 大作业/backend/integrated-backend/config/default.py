...
MIDDLEWARE += ("core.middleware.ApiRequestCollectMiddleware",)
...
_cors_allowed_origin = os.getenv("CORS_ALLOWED_ORIGIN")
CORS_ALLOWED_ORIGINS = [_cors_allowed_origin] if _cors_allowed_origin else []
