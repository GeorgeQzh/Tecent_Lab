...
export default {
  ...
  actions: {
    ...
    getBehaviorSummary(context, params, config = {}) {
      // eslint-disable-next-line no-undef
      return http.get(BACKEND_API_PREFIX+`/behavior-summary`, params, config);
    },
    getDashboardConfig(context, params, config = {}) {
      // eslint-disable-next-line no-undef
      return http.get(BACKEND_API_PREFIX+`/dashboard-config`, params, config);
    },
  },
};
